...
PATHS='runs sdpixl_runs* judge_* gen32* abl* speed*.json trd_*.txt b3*.txt vj*.txt nod32*.txt tanchor*.txt b2canvas*.txt drift*.txt eval_*Vmat*.json m3[0-9]_*.json m4[0-9]_*.json m4[0-9]_*.txt m5[0-9]_*.json m5[0-9]_*.txt m41ab'
