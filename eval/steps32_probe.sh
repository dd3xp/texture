...
# ⚠ 2026-09-14 更正：那个"真人 64% / 0.534" 是**一个包**（74 张里 66 张来自
# ROllerozxa__mtg_tiled_32x），整份 val32 是 46% / 0.132 ≈ TRD 的 28% / 0.130。
# 见 analysis/arch/ref_pack_audit.py。本脚本测的那条机制照样被否掉，但别再引这个差距。
