...
LEDGER = {
    ...
    # (OP2) 第一次跑就在这一格响了：账本 (M72) 读数表把 CI 下界印成 0.0772，JSON 真值 0.0771497
    # => 账本那一格是「显示位数四舍五入笔误」，同段正文写的「差 0.00148」反而逐位正确（0.0771497-0.0756693）。
    # 判决 PHASE16_BELOW_HUMAN 两种写法下同号、不受影响。此处改的是我的期望常数，不是检验本身。
    ("M72", 16): (0.0902, 0.0771, 0.1031, 0.0117),
